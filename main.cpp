...
static XNucleoIKS01A2 *p_mems_expansion_board = XNucleoIKS01A2::instance(D14, D15);
...
/*
 * Sets up an application dependent transmission timer in ms. Used only when Duty Cycling is off.
 */
#define TX_TIMER                        15000
...
/**
 * Entry point for application / main thread
 */
int main (void)
{
    // setup tracing
...
static void send_message()
{
    ...
    if ( err != 0) {  
        ...
        printf ("Pressure mBar: %5.2f\n\r", press); 
    }
      
    CayenneLPP payload(50);
    payload.addTemperature(1, temp); // save space
    payload.addRelativeHumidity(2, hum); // save space
    payload.addBarometricPressure(3, press); // save space
